...
const Login = () => {
    ...
    const headerStyle = {
        minheight:"100vh",
        backgroundImage: "url('https://img.freepik.com/foto-gratis/imagen-primer-plano-programador-trabajando-su-escritorio-oficina_1098-18707.jpg')",
    ...
    <div className="container-fluid">
      ...
      <a className="navbar-brand" href="#">
        ...
        {mensaje && <div className={estilo.toast}>{mensaje}</div>}
      ...
      <footer
        ...
        style={{ 
            backgroundColor: "rgba(76, 58, 77, 0.778)",
            position: "absolute",
            bottom: "0",
            width: "100%",                
         }}
